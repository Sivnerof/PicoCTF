...
After decrypting the correct password hash we'll see that the password used was ```8b95```. Running the Python program with the newly found password will reveal the flag.
